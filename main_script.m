...
sys_param.simulation.alpha  = load('monthly_ratio_alpha.txt','-ascii') ;
sys_param.simulation.beta   = load('monthly_ratio_beta.txt','-ascii') ;
sys_param.simulation.gamma  = load('monthly_ratio_gamma.txt','-ascii') ;
...
moea_param.gen  = 500; % number of generation
